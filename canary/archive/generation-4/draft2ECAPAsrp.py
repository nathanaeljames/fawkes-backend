...
async def main():
    ...
    global ecapa_processor  # Add this global
    ...
    # Load in-memory ECAPA matching routine (move this up before ecapa_processor init)
...
# Integration code for process_audio_from_queue():
"""
Add this code to your process_audio_from_queue() function:
...
Usage example for creating initial imprints:
# Replace your old extract_xtts_embed calls with:
await ecapa_processor.create_initial_speaker_imprint("/path/to/speaker.wav", "john", "doe")
"""