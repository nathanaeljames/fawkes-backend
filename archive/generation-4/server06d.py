...
async def main():
    ...
    # 2. Call the extract_xtts_embed function
    wav_path = "/root/fawkes/audio_samples/neilgaiman_01.wav"
    try:
        await xtts_wrapper.extract_xtts_embed(wav_path, firstname="neil", surname="gaiman")
    except FileNotFoundError:
        print(f"Error: The file {wav_path} was not found. Please check the path and try again.")
    except Exception as e:
