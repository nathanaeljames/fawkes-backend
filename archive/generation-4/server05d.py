# First (semi-)working model using canary-qwen, but speed is unusable and 
# circling back to test VAD after NeMo library upgrade
# Marblenet VAD fixed (requires strict=False)
